import { PixelCluster } from "./clouds";
...
export function Band({ id, title, text }: { id?: string; title: string; text: string }) {
  return (
    <div id={id} className="relative z-10 scroll-mt-24 border-y border-border bg-paper-2/70">
      <div className="mx-auto grid w-full max-w-[1200px] items-center gap-4 px-5 py-9 sm:px-8 md:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] md:gap-10">
