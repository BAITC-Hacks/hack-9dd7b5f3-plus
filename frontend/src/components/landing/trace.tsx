...
export function TraceSection() {
  return (
    <section className={SECTION}>
      <SectionHead title="Каждая реплика оставляет след." text="Четыре шага, и все они видны супервизору в формате из стартового кита кейса." />
      <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)]">
      <div className={CARD + " p-6"}>
        <ol className="divide-y divide-border">
          {STEPS.map((s, i) => (
            <li key={s.t} className="grid grid-cols-[40px_1fr] gap-3 py-4 first:pt-0 last:pb-0">
